...
plugins {
    ...
    // Must come after the Android plugin: it hooks each variant to turn
    // google-services.json into Firebase string resources. Without it,
    // firebase_core throws "Default FirebaseApp is not initialized" at launch.
